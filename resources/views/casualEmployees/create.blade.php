...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Casual Employee</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('casualEmployees.index')}}">Casual</a></li>
              <li class="breadcrumb-item active">Add Casual Employee</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<form action="{{ route('casualEmployees.store') }}" method="POST" name="formWithAutoCal">
    @csrf
<!-- general form elements -->
<!-- /.card-header -->
<br>
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Add New Casual Employee</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
    ...
    <div class="card card-primary">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
              ...
              <div class="form-group">
                <label>RATA</label>
                <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_rata" placeholder="RATA">
            </div>
            <!-- RATA -->
        </div>
        <!-- Date -->
    ...
    <div class="col-md-6">
        <div class="card card-primary">
          ...
          <div class="card-body">
                ...
                <div class="form-group">
                    <label>PERA</label>
                    <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_pera" placeholder="PERA" required>
                </div>
                <!-- PERA -->
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_midEndBonus" placeholder="MIDYEAR AND YEAREND BONUS" required>
                </div>
                <!-- MIDYEAR AND YEAREND BONUS -->
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_uniAllow" placeholder="Clothing Allowance" required>
                </div>
                <!-- CLOTHING ALLOWANCE -->
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_cellAllow" placeholder="Cellphone Allowance">
            </div>
            <!-- Cellphone Allowance -->
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_cashGift" placeholder="Cash Gift" required>
            </div>
            <!-- Cash Gift -->
        </div>
    </div>
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_annivBonus" placeholder="Anniversary Bonus">
                </div>
                <!-- Anniversary Bonus -->
                ...
                <div class="form-group">
                    <label>PEI</label>
                    <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_pei" placeholder="PEI" required>
                </div>
                <!-- PEI -->
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="card card-primary">
          ...
          <div class="card-body">
                ...
                <div class="form-group">
                    <label>ECC</label>
                    <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_ecc" placeholder="ECC" required>
                </div>
                <!-- ECC -->
                ...
                <div class="form-group">
                    <label>PAGIBIG</label>
                    <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_pagibig" placeholder="PAGIBIG" required>
                </div>
                <!-- PAGIBIG -->
                ...
                <div class="form-group">
                    <label>PHIC</label>
                    <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_phic" placeholder="PHIC" required>
                </div>
                <!-- PHIC -->
                ...
                <div class="form-group">
                    <label>GSIS</label>
                    <input type="number" class="form-control input-filled" onblur="getTotal();" step=".01" name="emp_gsis" placeholder="GSIS" required>
                </div>
                <!-- GSIS -->
        </div>
    </div>
